...
#ifndef INCLUDE_PLAYERINTERACTIVECOMPONENT_H_
#define INCLUDE_PLAYERINTERACTIVECOMPONENT_H_

#include "IComponent.h"

namespace adventure {

class PlayerInteractiveComponent : public IComponent {
public:
	PlayerInteractiveComponent();
	virtual ~PlayerInteractiveComponent();

	IPlayable* createInstance(FlexArguments*);

	static const std::string INTERACTIVE_PLAYER;

};

} /* namespace adventure */

#endif /* INCLUDE_PLAYERINTERACTIVECOMPONENT_H_ */
